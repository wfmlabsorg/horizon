# travelers-daily-2026-07-v001.csv

**Ledger:** travelers-daily · **Period:** 2026-07 · **Version:** v001 · **Supersedes:** none
...
Synthetic data with a recorded ground truth in `sim/GROUND-TRUTH.md`; regenerate with `bun run sim/generate.ts`. Rows in this file: 12. A re-pull would be `v002` with `supersedes: v001`; this file is never overwritten.
