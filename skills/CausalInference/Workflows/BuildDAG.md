...
```
HORIZON: What causal question are you trying to answer?

User: Does our training program improve employee retention?

HORIZON: Got it. Let's build the causal diagram.
...
HORIZON: Good. Let me add those as confounders:
- Engagement → Training
...
HORIZON: Good instrument! Adding:
...
HORIZON: Adding unmeasured confounder:
