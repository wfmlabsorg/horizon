...
**Key Insight:** When other HORIZON skills (BookOfWhy, CausalInference, DataAnalysis, etc.) are used to produce an analysis, this challenger:
...
**Important:** This skill does NOT take other HORIZON skills as authoritative—it examines them to understand what was *supposed* to happen, then challenges whether it *actually* happened correctly.
...
### Skills Invoked
[List of HORIZON skills used, with links to their SKILL.md files read]
