...
Identify and examine which HORIZON skills were used in an analysis.

---

## Purpose

Before challenging anything, establish exactly what methodologies were employed by identifying which HORIZON skills were invoked and reading their documentation to understand the intended process.
...
This analysis used [N] HORIZON skills to answer the question: "[Question]"
