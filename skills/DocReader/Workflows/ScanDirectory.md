...
bun run ~/.claude/skills/DocReader/Tools/doc.ts scan ~/horizon/books/<client>/01-source

# Scan current project
bun run ~/.claude/skills/DocReader/Tools/doc.ts scan ~/horizon/books/<client>/
```
