...
> **Purpose:** Enable HORIZON to read any document format and extract structured content for downstream processing.
...
- ~/horizon/books/<client>/01-source/file.xlsx
- ~/horizon/books/<client>/02-processed/file.docx
