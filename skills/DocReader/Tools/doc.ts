...
Examples:
  doc read "~/horizon/books/halcyon/01-source/report.docx"
  doc excel "~/horizon/books/halcyon/01-source/scores.xlsx" "Sheet1"
  doc scan "~/horizon/books/halcyon/01-source/"`);
    process.exit(0);
  }
