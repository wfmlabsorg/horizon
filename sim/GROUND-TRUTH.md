...
**For validation only. The agent chain is not shown this file; it is used to check what the chain recovers.**
...
| E4 | Home team classroom training | 36–49 | 08-24 → 09-06 | 10 heads, productive 0 | Supply rows: agents_in_training 10, productive_hours 0 |
